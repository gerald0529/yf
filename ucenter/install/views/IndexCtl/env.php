...
<p id="logo"><a href="http://www.yuanfeng.cn" tabindex="-1">用户中心</a></p>
...
<div class="step"><a href="./index.php?met=env&language=zh_CN" class="button button-large" id="recheck">重新检测</a> <a href="./index.php?met=db&language=zh_CN" class="button button-large button-disabled"  id="next_step">下一步</a></div>
