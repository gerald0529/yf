...
Yf_Registry::set('index_page', 'admin.php');
...
include_once 'imbuilder_api.ini.php';
Yf_Registry::set('imbuilder_erp_key', $imbuilder_erp_key);
Yf_Registry::set('app_id', $app_id);
Yf_Registry::set('imbuilder_api_url', $imbuilder_api_url);


//用户中心配置
include_once 'ucenter_api.ini.php';
...
Yf_Registry::set('shop_admin_api_url', $shop_admin_api_url);
//
//用户中心配置
...
Yf_Registry::set('paycenter_api_name', $paycenter_api_name);
//
//用户中心配置
