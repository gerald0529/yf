...
function initGrid()
{
    ...
    $("#grid").jqGrid({
        url: "./admin.php?ctl=Service_Idea&met=ideaList&typ=json&isDelete=2",
        datatype: "json",
...
var handle = {
    operate: function (t, e)
    {
        ...
        $.dialog({
            title: i,
            content: "url:./admin.php?ctl=Service_Idea&met=manage",
            data: a,
            width: 650,
            height: 420,
            max: !1,
    ...
    }, del: function (t)
    {
        ...
        {
            Public.ajaxPost("./admin.php?ctl=Service_Idea&met=remove&typ=json", {idea_id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
