function init()
{
    typeof cRowId != "undefined" ? Public.ajaxPost("./admin.php?ctl=Service_Idea&met=get", {
    ...
    $_form.validator({
        ...
        valid: function (form)
        {
            ...
            delete b.firstLink,
                ...
                Public.ajaxPost("./admin.php?ctl=Service_Idea&typ=json&met=" + ("add" == oper ? "add" : "edit"), b, function (e)
                {
                    if (200 == e.status)
                    {
...
function initEvent()
{
    ...
    type = $("#type").combo({
        data: "./index.php?ctl=Vendor_Type&met=queryAllType&typ=json",
    ...
    level = $("#level").combo({
        data: "./index.php?ctl=Vendor_Level&met=queryAllLevel&typ=json",
    ...
    $(".grid-wrap").on("click", ".ui-icon-ellipsis", function (a)
    {
        ...
        parent.$.dialog({
            title: "联系地址",
            content: "url:./index.php?ctl=Base_Address&met=index",
            data: {
