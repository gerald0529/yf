...
function postData(t, e)
{
    $_form.validator({
        ...
        valid: function (form)
        {
            ...
            Public.ajaxPost("./admin.php?ctl=Message_Record&met=sendMessage&typ=json", params, function (e)
            // Public.ajaxPost(SITE_URL +'?ctl=User_Info&met=send&typ=json', params, function (e)
            {
                if (200 == e.status)
                {
