...
$(function () {
    ...
    function b() {
        var a = Public.setGrid(),
            ...
            l = [
                /*{name: 'operate',label: '操作',width: 35,fixed: !0,
                ...
                {name: 'date_created',label: '发送时间',width: 200,align: 'center'},
        ...
        j.gridReg('grid', l),
            ...
            $('#grid').jqGrid({
                // url: './admin.php?ctl=Message_Record&met=getList&typ=json',
                url:SITE_URL +'?ctl=User_Info&met=getList&typ=json',
                datatype: 'json',
                autowidth: true,
                shrinkToFit:true,
                forceFit:false,
    ...
    var d = (parent.SYSTEM, Number(parent.SYSTEM.qtyPlaces), Number(parent.SYSTEM.pricePlaces)),
        ...
        h = {
            ...
            setStatus: function (a, b) {
                a && Public.ajaxPost('./admin.php?ctl=Purchase_Information&met=change&typ=json', {
                    id: a,
            ...
            setStatuses: function (a, b) {
                if (a && 0 != a.length) {
                    var c = $('#grid').jqGrid('getGridParam', 'selarrrow'),
                        d = c.join();
                    Public.ajaxPost('./admin.php?ctl=Purchase_Information&met=change&typ=json', {
                        id: a,
                        server_status: Number(b)
                    }, function (c) {
                        if (c && 200 == c.status) {
