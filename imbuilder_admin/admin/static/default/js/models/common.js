...
Public.getDefaultPages = function(){
    var win = window.self;
    var i = 20;//最多20层，防止无限嵌套
    try{
        do{
...
Business.customerCombo = function($_obj, opts){
    ...
    $('#quickAddCustomer').on('click', function(e){
        ...
        $.dialog({
            title : '新增客户',
            content : 'url:./index.php?ctl=Member_Base&met=manage',
...
Business.billSalesCombo = function($_obj, opts){
    ...
    opts = $.extend(true, {
        data: function(){
            if(defaultPage.SYSTEM.salesInfo) {
                ...
                return './index.php?ctl=Base_Employee&met=employeeList&typ=json';
            }
        }
    }, opts);
  ...
  Business.salesCombo = function($_obj, opts){
    ...
    $('#quickAddSales').on('click', function(e){
        ...
        $.dialog({
            title : '新增职员',
            content : 'url:./index.php?ctl=Base_Employee&met=manage',
            data: {oper: 'add', callback: function(data, oper, dialogWin){
                //parent.getCustomer();
                //_self.customerCombo.selectByValue(data.id, false);
                salesCombo.loadData('./index.php?ctl=Base_Employee&met=employeeList', ['id', data.id]);
                dialogWin && dialogWin.api.close();
            }},
            width : 400,
            height : 160,
...
Business.supplierCombo = function($_obj, opts){
    ...
    $('#quickAddVendor').on('click', function(e){
        ...
        $.dialog({
            title : '新增供应商',
            content : 'url:./index.php?ctl=Vendor_Base&met=manage',
            data: {oper: 'add', callback: function(data, oper, dialogWin){
                //parent.getCustomer();
                //_self.customerCombo.selectByValue(data.id, false);
...
Business.cacheManage = {
    ...
    getGoodInfo:function(params, callback, effective){
        ...
        //本地匹配不到，则去后端查找
        $.ajax({
            url: './index.php?ctl=Goods_Base&met=goodsList&isDelete=2&typ=json',
            type: 'post',
            dataType: 'json',
            data: params,
            async:false,//勿修改该属性
...
Business.serNumManage = function(opts){
    ...
    var params = {
        ...
        content: 'url:./index.php?ctl=Goods_Base&met=sernum',
        data: {
            invId: data.id,
            creatable:creatable,
    ...
    if(enableStorage){
        ...
        params.title = '选择【'+data.goods_name+'】的序列号',
            params.content = 'url:./index.php?ctl=Sale_Bill&met=serNumList';
    ...
    if(opts.type == 'sales')
    {
    	params.content = 'url:./index.php?ctl=Goods_Base&met=sernum#type=sales';
    }
    if(view){
        //查询模式
        params.cancel = true;
...
Business.billSkuManage = function(parentTr , data, isSkuSingle){
    ...
    $.dialog({
        ...
        content: 'url:./index.php?ctl=Goods_Base&met=skus',
        data: {
            //skey:_self.skey,
...
Business.categoryCombo = function($_obj, opts, type){
    ...
    var defaultPage = Public.getDefaultPages();
    var opts = $.extend(true, {
        data: function(){
...
Business.forSearch = function(id, text){
    if(id) {
        $.dialog({
            ...
            height: 410,
            title: '商品库存查询',
            //content: 'url:./index.php?ctl=Goods_WarehouseSku&met=index',
            content: 'url:./index.php?ctl=Goods_WarehouseSku&met=manage&goods_id=' + id,
    ...
    var opts = $.extend(true, {
        data: function(){
            if(SYSTEM.paymentInfo) {
                ...
                return './index.php?ctl=Base_SettlementAccountType&met=SettlementAccountTypeLists&typ=json';
            }
        },
        ajaxOptions: {
            formatData: function(data){
    ...
    var opts = $.extend(true, {
        data: function(){
            if(SYSTEM.storeInfo) {
                ...
                return './index.php?ctl=Store_Base&met=baseList&typ=json';
            }
        },
        ajaxOptions: {
            formatData: function(data){
    ...
    var opts = $.extend(true, {
        data: function(){
            if(SYSTEM.logisticInfo) {
                ...
                return './index.php?ctl=Express_Base&met=baseList&typ=json';
            }
        },
        ajaxOptions: {
            formatData: function(data){
    ...
    if(type !== 'assemble') {
        $('#customer').on('click', '.ui-icon-ellipsis', function(e){
            ...
            if(lable === '供应商' || lable === '购货单位') {
                var content = 'url:./index.php?ctl=Customer_Base&met=select&type=10';
            } else {
                var content = 'url:./index.php?ctl=Customer_Base&met=select';
            }
        ...
        $('.grid-wrap').on('click', '.goods .ui-icon-ellipsis', function(e){
            ...
            $.dialog({
                ...
                content: 'url:./index.php?ctl=Goods_Base&met=select',
...
Public.print = function (opt){
    ...
    $.dialog({
        title: opt.title,
        content : 'url:./index.php?ctl=PrintSettings',
        ...
        init:function(){
            ...
            var dialog = myParent.$.dialog({
                ...
                ok:function(){
                    ...
                    var msg = '新增类别';
                   // alert(callback);
                    Public.ajaxPost('./index.php?ctl=Finance_OtherType&met=income_add&income_type_name=' + params.name,params, function(data){
                        if (data.status == 200) {
