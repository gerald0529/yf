...
class ApiCtl extends Yf_AppController
{
    ...
    {
        $systemMessageModel = new System_MessageModel();
        $data = $systemMessageModel->get('*');
    ...
    public function getSystemMessageById()
    {
        $id = $_POST['id'];
        $systemMessageModel = new System_MessageModel();
        $systemMessageModel->sql->setWhere('system_message_id',$id);
        $res = $systemMessageModel->get('*');
