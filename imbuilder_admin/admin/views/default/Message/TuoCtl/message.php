...
<div class="wrapper page">
	<!-- 操作说明 -->
    <p class="warn_xiaoma"><span></span><em>此处仅显示未读托管消息，便于快速回复用户。</em></p><div class="explanation" id="explanation">
	...
	<div class="fixed-bar">
	    <div class="item-title">
	      <div class="subject">
	        <h3>消息托管</h3>
	        <h5>此处仅显示未读托管消息，便于快速回复用户。</h5>
	      </div>
		      <ul class="tab-base nc-row">
                <li><a href="###" class="current"><span>托管消息</span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Message_Tuo&met=store" class=""><span>托管商家</span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Message_Tuo&met=store_add" class=""><span>新增托管商家</span></a></li>
	          </ul>
	    </div>
 	</div>
...
<script src="./admin/static/default/js/controllers/message/tuo.js"></script>
<?php
