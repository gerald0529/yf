...
<!--	         <li><a href="http://admin.im-builder.com/admin.php?ctl=Message_Record&met=manage" class="current"><span>用户信息</span></a></li>-->
			  <li><a href="###" class="current"><span>用户信息</span></a></li>
	     </ul>
	    </div>
 	</div>
	<div class="mod-search cf">
		...
		<div class="fr">
			...
			<a href="#" class="ui-btn ui-btn-sp" id="btn-batchDel">推送消息</a>
		</div>
	</div>
	<div class="cf">
