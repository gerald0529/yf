...
<link href="./admin/static/default/css/index.css" rel="stylesheet" type="text/css">
<script src="./admin/static/default/js/libs/template.js"></script>
</head>
<body>
<div id="hd" class="cf">
	<div class="fl welcome cf">
		<strong><span id="greetings"></span>，<span id="username"></span></strong>
<!--		<a  id="manageAcct">账号管理</a>-->
		...
		<div class="main-wrap cf">
			<div class="m-top cf" id="profileDom">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="20">
					<tr>
					    <td><a class="ta t6" tabid="setting-goodsList" data-right="INVENTORY_QUERY" tabTxt="商品管理" parentOpen="true" rel="pageTab" href=""></a></td>
						<td><a class="ta t7" tabid="setting-customerList" data-right="BU_QUERY" tabTxt="客户管理" parentOpen="true" rel="pageTab" href=""></a></td>
					    <td><a class="ta t9"tabid="setting-vendorList" data-right="PUR_QUERY" tabTxt="供应商管理" parentOpen="true" rel="pageTab" href=""></a></td>
						<td><a class="ta t1" tabid="report-initialBalance" data-right="InvBalanceReport_QUERY" tabTxt="商品库存余额" parentOpen="true" rel="pageTab" href=""></a></td>
						<td><a class="ta t2 soon" href="javascript:void(0);" tabid="report-cashBankJournal" data-right="SettAcctReport_QUERY" tabTxt="现金银行报表" parentOpen="true" rel="pageTab" ></a></td>
						<td><a class="ta t3 soon"  href="javascript:void(0);" tabid="report-contactDebt" data-right="ContactDebtReport_QUERY" tabTxt="往来单位欠款表" parentOpen="true" rel="pageTab" ></a></td>
						<td><a class="ta t4" tabid="report-salesSummary" data-right="SAREPORTINV_QUERY" tabTxt="销售汇总表（按商品）" parentOpen="true" rel="pageTab" href=""></a></td>
						<td><a class="ta t5" tabid="report-puSummary" data-right="PUREPORTINV_QUERY" tabTxt="采购汇总表（按商品）" parentOpen="true" rel="pageTab" href=""></a></td>
			...
			<ul class="quick-links">
				<li class="purchase-purchase">
					<a tabid="purchase-purchase" data-right="PU_ADD" tabTxt="购货单" parentOpen="true" rel="pageTab" href=""><span></span></a>
				</li>
				<li class="sales-sales">
					<a tabid="sales-sales" data-right="SA_ADD" tabTxt="销货单" parentOpen="true" rel="pageTab" href=""><span></span></a>
				</li>
				...
				<li class="storage-inventory">
					<a tabid="storage-inventory" data-right="PD_GENPD" tabTxt="盘点" parentOpen="true" rel="pageTab" href=""><span></span></a>
				</li>
				<li class="storage-inventory">
				<a tabid="sales-salesList" data-right="SA_QUERY" tabTxt="销货记录" parentOpen="true" rel="pageTab" href=""><span></span></a>
<!--					<a tabid="storage-inventory" data-right="PD_GENPD" tabTxt="盘点" parentOpen="true" rel="pageTab" href="./index.php?ctl=Goods_WarehouseSku"><span></span>库存盘点</a>-->
				</li>
				<li class="storage-inventory">
				<a tabid="purchase-salesList" data-right="PU_QUERY" tabTxt="采购记录" parentOpen="true" rel="pageTab" href=""><span></span></a>

<!--					<a tabid="storage-inventory" data-right="PD_GENPD" tabTxt="盘点" parentOpen="true" rel="pageTab" href="./index.php?ctl=Goods_WarehouseSku"><span></span>库存盘点</a>-->
				</li>
				<li class="storage-otherWarehouse">
				<a href="" rel="pageTab" tabid="money-receiptList" tabTxt="收款记录" data-right="RECEIPT_QUERY" parentOpen="true"><span></span></a>
				...
				<a href="" rel="pageTab" tabid="money-paymentList" tabTxt="付款记录" data-right="PAYMENT_QUERY" parentOpen="true"><span></span></a>
	...
	<!--<div class="col-extra">
		<div class="extra-wrap">
			...
			<div class="list">
				<ul>
					<li><a tabid="setting-goodsList" data-right="INVENTORY_QUERY" tabTxt="商品管理" parentOpen="true" rel="pageTab" href="./index.php?ctl=Goods_Base">商品管理</a></li>
					<li><a tabid="setting-customerList" data-right="BU_QUERY" tabTxt="客户管理" parentOpen="true" rel="pageTab" href="./index.php?ctl=Member_Base">客户管理</a></li>
					<li><a tabid="setting-vendorList" data-right="PUR_QUERY" tabTxt="供应商管理" parentOpen="true" rel="pageTab" href="./index.php?ctl=Vendor_Base">供应商管理</a></li>
					<li><a tabid="sales-salesList" data-right="SA_QUERY" tabTxt="销货记录" parentOpen="true" rel="pageTab" href="./index.php?ctl=Sale_Bill&met=indexList">销售记录</a></li>
					<li><a tabid="purchase-salesList" data-right="PU_QUERY" tabTxt="采购记录" parentOpen="true" rel="pageTab" href="./index.php?ctl=Purchase_Bill&met=purchaseList">采购记录</a></li>
					<li><a href="./index.php?ctl=Finance_ReceiptBill&met=manage" rel="pageTab" tabid="money-receiptList" tabTxt="收款记录" data-right="RECEIPT_QUERY" parentOpen="true">收款记录</a></li>
					<li><a href="./index.php?ctl=Finance_PaymentBill&met=manage" rel="pageTab" tabid="money-paymentList" tabTxt="付款记录" data-right="PAYMENT_QUERY" parentOpen="true">付款记录</a></li>
					...
					<li><a href="/report/puDetail.do?action=detail" rel="pageTab" tabid="report-puDetail" tabTxt="采购明细表" data-right="PUREOORTDETAIL_QUERY" parentOpen="true">采购明细表</a></li>
...
<script id="profile" type="text/html">
	<table width="100%" border="0" cellspacing="0" cellpadding="20">
		<tr>
			<td><a class="tad t1" tabid="report-initialBalance" data-right="InvBalanceReport_QUERY" tabTxt="商品库存余额" parentOpen="true" rel="pageTab" href=""><span>库存总量:<b><#= items[0].total1 #></b></span><span>库存成本:<b><#= items[0].total2 #></b></span></a></td>
			<td><a class="tad t2" tabid="report-cashBankJournal" data-right="SettAcctReport_QUERY" tabTxt="现金银行报表" parentOpen="true" rel="pageTab" href=""><span>现金:<b><#= items[1].total1 #></b></span><span>银行存款:<b><#= items[1].total2 #></b></span></a></td>
			<td><a class="tad t3" tabid="report-contactDebt" data-right="ContactDebtReport_QUERY" tabTxt="往来单位欠款表" parentOpen="true" rel="pageTab" href=""><span>客户欠款:<b><#= items[2].total1 #></b></span><span>供应商欠款:<b><#= items[2].total2 #></b></span></a></td>
			<td><a class="tad t4" tabid="report-salesSummary" data-right="SAREPORTINV_QUERY" tabTxt="销售汇总表（按商品）" parentOpen="true" rel="pageTab" href=""><span>销售收入(本月):<b><#= items[3].total1 #></b></span><span>销售毛利(本月):<b><#= items[3].total2 #></b></span></a></td>
			<td><a class="tad t5" tabid="report-puSummary" data-right="PUREPORTINV_QUERY" tabTxt="采购汇总表（按商品）" parentOpen="true" rel="pageTab" href=""><span>采购金额(本月):<b><#= items[4].total1 #></b></span><span>商品种类(本月):<b><#= items[4].total2 #></b></span></a></td>
		</tr>
	</table>
	<i></i>
</script>
...
<script>
	...
	$("#feedback").click(function(e){
		e.preventDefault();
		parent.tab.addTabItem({tabid: 'myService', text: '服务支持', url: '', callback: function(){
