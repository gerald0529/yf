    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=api&config_type%5B%5D=im"><span>本系统 API设置</span></a></li>
  ...
  ?>
    ...
    <form method="post" id="shop_api-setting-form" name="settingForm">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="site_name">shop后台 URL</label>
                </dt>
                <dd class="opt">
                    <input id="shop_admin_api_url" name="shop_api[shop_admin_api_url]" value="<?=Yf_Registry::get('shop_admin_api_url')?>" class="w400 ui-input " type="text"/>
