    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=api&config_type%5B%5D=im"><span>本系统 API设置</span></a></li>
    ...
    <form method="post" id="paycenter-shop_api-setting-form" name="paycenterSettingForm">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="paycenter_api_name" name="im_api[im_api_name]" value="<?=Yf_Registry::get('im_api_name')?>" class="w400 ui-input " type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="paycenter_api_url" name="im_api[im_url]" value="<?=Yf_Registry::get('im_url')?>" class="w400 ui-input " type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="paycenter_api_url" name="im_api[im_api_url]" value="<?=Yf_Registry::get('im_api_url')?>" class="w400 ui-input " type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="paycenter_api_key" name="im_api[im_api_key]" value="<?=Yf_Registry::get('im_api_key')?>" class="ui-input w400" type="text"/>
