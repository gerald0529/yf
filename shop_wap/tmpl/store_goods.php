    ...
    <header id="header" class="nctouch-store-header">
        <div class="header-wrap">
            <div class="header-l">
             ...
             <div class="header-inp clearfix header-inp-wreset"> <i class="icon"></i>
                <input type="text" class="search-input" id="goods_search"  placeholder="搜索店铺内商品" maxlength="50" autocomplete="on" autofocus>
            </div>
      ...
      <p>分类</p>
    </a>  --><a id="search_btn" href="javascript:void(0);" class="search-btn">搜索</a><a id="header-nav" href="javascript:void(0);"><i class="more"></i><sup></sup></a></div>
        </div>
