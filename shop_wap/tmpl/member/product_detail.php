        ...
        <div class="nctouch-nav-layout">
            <div class="nctouch-nav-menu"> <span class="arrow"></span>
                <ul>
                    ...
                    <li><a href="javascript:void(0);"><i class="share"></i>分享<sup></sup></a></li>
                </ul>
            </div>
        </div>
    </header>
            ...
            <% if (goods_info.promotion_type == 'xianshi' || goods_info.promotion_type == 'groupbuy' || (mansong_info != null && mansong_info.rules) || (gift_array && !isEmpty(gift_array))) { %>
                    ...
                    <div class="item-con">
                        <% if (goods_info.promotion_type == 'xianshi') { %>
                            <dl class="goods-detail-sale">
                                ...
                                <dd>
                                    直降￥
                                    <%=goods_info.down_price%>
                                        <% if( goods_info.lower_limit ) { %>
                                            最低
                                            <%=goods_info.lower_limit%>件起，
                                                <%=goods_info.explain%>
                                                    <%  } %>
                                                        <dd>
                            </dl>
                ...
                <% } %>
                        ...
                        <%}%>
                            ...
                            <div class="goods-detail-item goods-detail-o2o mt5 mb5">
                                ...
                                <div class="more-location">
                                    <a href="javascript:void(0);" id="store_addr_list"></a><i class="arrow-r"></i></div>
                            </div>
					...
					<span class="user-name"><%=goods_eval_list[i].geval_frommembername%></span>
                                                        ...
                                                        <dd>
                                                            <%=goods_eval_list[i].geval_content%>
                                                        </dd>
                                                    </dl>
                                                    <% }} %>
                                        </div>
                                    ...
                                    <% if (store_info.is_own_shop != 1) {%>
                                        <div class="goods-detail-store">
                                            <a href="store.html?shop_id=<%= store_info.shop_id %>">
                                                <div class="store-name"><i class="icon-store"></i>
                                                ...
                                                <dl class="spec-promotion">
                                                    ...
                                                    <dd>
                                                        <a href="javascript:void(0);" class="current">
                                                            <%= goods_info.presell_deliverdate_str %> 日发货</a>
                                                    </dd>
                                                </dl>
                                                <% } %>
                            ...
                            <% for (var i=0; i<voucher.length; i++) { %>
                                <li>
                                    <dl>
                                        ...
                                        <dd class="need">需消费
                                            <%=voucher[i].voucher_t_limit%>使用</dd>
                                        <dd class="time">至
                                            <%=voucher[i].voucher_t_end_date_day%>前使用</dd>
                                        <dl>
