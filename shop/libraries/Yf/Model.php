<?php
    ...
    class Yf_Model extends Yf_Singleton
    {
        ...
        public $htmlKey = array('common_service');
        public $oriKey  = array();
         ...
         * @access public
         */
        public function listByWhere($cond_row, $order_row = array(), $page = 1, $rows = 100, $flag = true, $group = null)
        {
            //需要分页如何高效，易扩展
            $offset = $rows * ($page - 1);
        ...
        protected function _insert(&$a)
        {
            ...
            $sql .= implode(', ', $data_row); //var_dump($sql);
        ...
        protected function _update(&$a, $flag = null)
        {
            ...
            $sql .= $this->sql->getWhere();//var_dump($sql);
