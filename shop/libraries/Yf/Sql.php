<?php
    ...
    class Yf_Sql
    {
                public static $dbTransFlag = false;        /* 构造Sql语句where        */
                public static $dbTransRow = array();        /* 构造Sql语句Limit        */
        public static $logsTransRow = array();
                public static $cachesTransRow = array();                /* 数据库对象            */
                public static $redisTransRow = array();                /* 数据库对象id            */
        public $sql = null;
        public $lastSql = null;
