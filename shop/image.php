    ...
    if (isset($_SERVER['PATH_INFO'])) {
        ...
        if (isset($file_row[1])) {
            ...
            if (is_file($file_path)) {
                echo file_get_contents($file_path, false, $context);
            } else {
                ...
                if (is_file($image_ori_path)) {
                    ...
                    // 如果图片没有设置，则调用webconfig表的值value_photo_goods_logo
                    // if () {
                    // }
                    //430x430q90.jpg
            ...
            $image_ori_path = ROOT_PATH . $image_ori;
            //原图
            echo file_get_contents($image_ori_path, false, $context);
        }
