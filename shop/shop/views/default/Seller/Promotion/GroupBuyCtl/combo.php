        ...
        <div class="form-style">
            <dl>
                ...
                <dd>
                    ...
                    <p class="hint"><?=__('每月您需要支付')?><?=format_money(Web_ConfigModel::value('groupbuy_price'))?>。</p>
    ...
    $(function(){
        $('#form').validator({
            ...
            valid: function(form){
                ...
                $.ajax({
                    url: "index.php?ctl=Seller_Promotion_GroupBuy&met=addCombo&typ=json",
                    data: $(form).serialize(),
                    type: "POST",
                    success:function(e){
                        if(e.status == 200)
                        {
                            ...
                            setTimeout("window.location.href='index.php?ctl=Seller_Promotion_GroupBuy&met=index&typ=e'",3000);
                        }
                        else
                        {
