...
<style>
	.select_2.hidden,.select_3.hidden,.select_4.hidden{display: none;}
	.bor-inp{
...
<div id="apply_company_info" class="apply-company-info">
  ...
  <form id="form_company_info"  method="post">
    ...
    <tbody>
        <tr>
          <th><i>*</i><?=__('手机号码')?>：</th>
          <td><input name="contacts_phone" class="w200 bor-inp" type="tel" maxlength="11" id="contacts_phone" value="<?php echo isset($shop_company['contacts_phone']) ? $shop_company['contacts_phone'] : '';?>" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i><?=__('图形验证码')?>：</th>
          <td>
              <input type="text"  name="img_yzm" id="img_yzm" maxlength="6" class="w200 bor-inp" placeholder="请输入验证码" default="<i class=&quot;i-def&quot;></i>看不清？点击图片更换验证码" />
              <img onClick="get_randfunc(this);" title="换一换" class="img-code hg26" style="cursor:pointer;" src='./libraries/rand_func.php'/>
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i><?=__('手机验证码')?>：</th>
          <td><input name="phone_verify" class="w200 bor-inp" type="text">
            <span></span><input type="button" onclick="getyzm('phone')" data-type="phone" value="<?=__('获取手机验证码')?>" id ='phone_yzm_bn' class="hg26"/></td>
        </tr>
        <tr>
          <th><i>*</i><?=__('邮箱')?>：</th>
          <td><input name="contacts_email" class="w200 bor-inp" type="email" id='contacts_email' value="<?php echo isset($shop_company['contacts_email']) ? $shop_company['contacts_email'] : '';?>" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i><?=__('邮箱验证码')?>：</th>
          <td><input name="email_verify" class="w200 bor-inp" type="text">
            <span></span><input type="button" onclick="getyzm('email')" data-type="email" value="<?=__('获取邮箱验证码')?>" id ='email_yzm_bn' class="hg26"/></td>
        </tr>
        <tr>
            <th><i>*</i><?=__('店铺所在地')?>：</th>
            <td>
            ...
            <div id="d_2">
                ...
                <select id="select_2" class="select_2" name="company_2" onChange="district(this);" >
    ...
    <table class="all" border="0" cellpadding="0" cellspacing="0">
      ...
      <tbody>
        ...
        <tr>
          <th><i>*</i><?=__('证件有效期')?>：</th>
          <td>
              <input readonly="readonly"  id="start_time"  name="business_licence_start"  class="w90 hasDatepicker" type="text" value="<?php echo (isset($user_info['user_identity_start_time']) && $user_info['user_identity_start_time'] > 0) ? $user_info['user_identity_start_time'] : '';?>" />
<!--              <em><i class="iconfont icon-rili"></i></em>-->
<!--            <span></span>-->
              -
            <input readonly="readonly" id="end_time" name="business_licence_end"  class="w90 hasDatepicker" type="text" value="<?php echo (isset($user_info['user_identity_end_time']) && $user_info['user_identity_end_time']> 0 ) ? $user_info['user_identity_end_time'] : '';?>" />
<!--              <em><i class="iconfont icon-rili"></i></em>-->
<!--            <span class="block">--><?//=__('此处时间只读，结束时间不填代表永久。')?><!--</span>-->
          </td>
        </tr>
      </tbody>
      <tfoot>
