  ...
  <form id="form_company_info"  method="post">
    ...
    <table class="all" border="0" cellpadding="0" cellspacing="0">
      ...
      <tbody>
        ...
        <tr>
          <th><i>*</i><?=__('公司电话')?>：</th>
          <td><input name="company_phone" class="w100 bor1" type="tel" value="<?php echo isset($shop_company['company_phone']) ? $shop_company['company_phone'] : '';?>">
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i><?=__('员工总数')?>：</th>
          <td><input name="company_employee_count" class="w50 bor1" type="number" value="<?php echo isset($shop_company['company_employee_count']) ? $shop_company['company_employee_count'] : '';?>">
            &nbsp;人 <span></span></td>
        </tr>
        <tr>
          <th><i>*</i><?=__('注册资金')?>：</th>
          <td><input name="company_registered_capital" class="w50 bor1" type="number" value="<?php echo isset($shop_company['company_registered_capital']) ? $shop_company['company_registered_capital'] : '';?>">
            &nbsp;万元<span></span></td>
        </tr>
        <tr>
          <th><i>*</i><?=__('联系人姓名')?>：</th>
...
<!--                <span class="block">--><?//=__('如果营业执照、组织机构代码证和税务登记证已经三证合为一证，仅需填写营业执照')?><!--</span>-->
            ...
            <tr>
                <th><i>*</i><?=__('营业执照号')?>：</th>
                <td><input name="business_id" class="w200" type="text" value="<?php echo isset($shop_company['business_id']) ? $shop_company['business_id'] : '';?>">&nbsp;&nbsp;&nbsp;<span class=""><?=__('多证合一的请填入“统一社会信用代码”')?></span></td>
            </tr>
            <tr>
