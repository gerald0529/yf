...
?>
    ...
    <div class="search fn-clear">
        <form id="search_form" class="search_form_reset" method="get" action="<?= Yf_Registry::get('url') ?>">
            ...
            <input type="hidden" name="ctl" value="Seller_Supplier_Goods">
            <input type="hidden" name="met" value="<?= $met ? $met : 'dist_online'; ?>">
            <a class="button refresh" href="index.php?ctl=Seller_Supplier_Goods&met=<?= $met ? $met : 'dist_online'; ?>&typ=e"><i
            ...
            <table class="table-list-style" width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <dl class="fn-clear fn_dl">
                                    ...
                                    <dd>
                                        <h3 style="width: 310px;">
                                            <?php if ($item['common_distributor_flag'] == 1) { ?><span style="color:red;"><?= __('（价格库存信息变更）') ?></span><?php } ?>
                                            <?php if ($item['common_distributor_flag'] == 2) { ?><span style="color:red;"><?= __('（商品内容变更）') ?></span><?php } ?>
                                            <a href="index.php?ctl=<?= $ctl ?>&met=goods&gid=<?= $item['goods_id'] ?>"
                ...
                <tr>
                    <td class="toolBar" colspan="1">
                        ...
                        <label class="del" data-param="{'ctl':'Seller_Goods','met':'deleteGoodsCommonRows'}">
