...
<div class="breadcrumb"><span class="icon-home iconfont icon-tabhome"></span><span><a href="index.php?ctl=index"><?=__('首页')?></a></span> <span class="arrow iconfont icon-btnrightarrow"></span> <span><?=__('个人入驻申请')?></span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
      <h3><?=__('个人入驻申请')?></h3>
...
<form id="form_company_info" method="post">
        ...
        <dl>
            ...
            <dd><input id="t" name="bank_address" type="hidden" value="<?php echo isset($shop_company['bank_address']) ? $shop_company['bank_address'] : '';?>">
            	<div id="d_2"  class="">
                        ...
                        <select id="select_2"  class="select_2" name="select_2" onChange="district(this);" >
                        ...
                        <select id="select_3" class="select_3" name="select_3" onChange="district(this);" >
    ...
    <div class="next"><a href="<?= Yf_Registry::get('base_url')?>/index.php?ctl=Seller_Supplier_Settled&met=index&op=pstep2&rp=pstep2&apply=1" class="btn bbc_btns"><?=__('上一步')?></a>&nbsp;&nbsp;&nbsp;<a class="button bbc_btns" id="btn_apply_company_next" href="javascript:;"><?=__('下一步，填写入驻预经营信息')?></a></div>
</form>    
</div>
  </div>
</div>
           ...
           valid:function(form){
                ...
                $.ajax({
                    ...
                    success:function(a){
                        if(a.status == 200)
                        {
                           location.href="./index.php?ctl=Seller_Supplier_Settled&met=index&op=step4&apply=<?=$apply?>";
                        }
                        else
                        {
