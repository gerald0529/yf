                    ...
                    <div class="content_s bbc-goods-list_2">
                        <ul>
                            <?php if(!empty($data)): foreach($data as $key=>$value):?>
                                <li>
                                    <dl>
                                        <dt><a href="index.php?ctl=<?=$ctl?>&met=goods&gid=<?=$value['goods_id'] ?>"
                                        ...
                                        <dd class="goods-name"><a
                                                href="index.php?ctl=<?=$ctl?>&met=goods&gid=<?=$value['goods_id'] ?>"
                                        ...
                                        <dd class="goods-info"><span class="priceSS bbc-color"><i></i> <?=format_money($value['common_price']) ?> </span> <span
                                                class="goods-sold"><?=__('已售')?>：<strong class="num-color"><?=$value['common_salenum'] ?></strong> <?=__('件')?></span></dd>
                                    </dl>
                                </li>
