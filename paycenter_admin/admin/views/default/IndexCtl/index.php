...
<!-- 			<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Login&met=loginout"><i class="nav_href">广告系统</i></a></li>
				...
				<li><a href="<?= Yf_Registry::get('paycenter_api_url') ?>" target="_blank"><i class="iconfont icon-top02"></i></a></li>
			...
			<div class="nav-wrap hidden cf"><!--订单-->
				...
				<div id="sub-nav">
					<ul class="cur cf" id="setting-base">
						...
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Message&met=template&typ=e" rel="pageTab" tabid="message_manage" tabtxt="消息管理">消息管理</a>
						</li>
