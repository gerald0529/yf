...
<head>
	...
	<title><?= _('欢迎您选用远丰IMBuilder系统') ?></title>
...
<p id="logo"><a href="http://www.yuanfeng.cn" tabindex="-1">IMBuilder</a></p>
		...
		<div class="select-module">
			<ul>
				...
				<li class="drp">
					...
					<div class="iconfont">&#xe64f;</div>
					<h4>分销</h4>
					<p>远丰分销系统是一套功能完善的多用户供应链分销系统....</p>
				</li>
				<li class="erp">
					<label><i class="iconfont">&#xe65a;</i>请联系销售人员</label>
					<div class="iconfont">&#xe64f;</div>
					<h4>Erp</h4>
					<p>远丰Erp系统是一套功能强大、安全稳定的电商ERP系统...</p>
				</li>
			</ul>
		</div>
	</form>
