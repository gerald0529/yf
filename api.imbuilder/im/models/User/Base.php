...
class User_Base extends Yf_Model
{
    ...
    public function editUserField($table_primary_key_value, $field_name, $field_value_new, $field_value_old, $flag=null){
        return $this->editSingleField($table_primary_key_value, $field_name, $field_value_new, $field_value_old, $flag=null);
    }
