...
class UploadCtl extends Yf_AppController
{
	...
	public function __construct(&$ctl, $met, $typ)
	{
		...
		if (!request_string('plantform') && Perm::$login && Perm::$userId)
		{
			if (Perm::$userId && Perm::$userId)
			{
				$dir_path = sprintf('/media/%s/%d/%d', Yf_Registry::get('server_id'), Perm::$userId, Perm::$userId);
			}
			else
			{
