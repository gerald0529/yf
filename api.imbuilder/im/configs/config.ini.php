...
define('CODE_TEMPLATE_PATH', ROOT_PATH . '/im/build_tools/code_template');
...
if (is_file(INI_PATH . '/im_' . $server_id . '.ini.php'))
{
	$im_config_row = include_once INI_PATH . '/im_' . $server_id . '.ini.php';
}
else
{
	$im_config_row = include_once INI_PATH . '/im.ini.php';
}
...
{
	include_once INI_PATH . '/ucenter_api_' . $server_id . '.ini.php';
}
else
{
	include_once INI_PATH . '/ucenter_api.ini.php';
}


if (is_file(INI_PATH . '/paycenter_api_' . $server_id . '.ini.php'))
{
	include_once INI_PATH . '/paycenter_api_' . $server_id . '.ini.php';
}
else
{
	include_once INI_PATH . '/paycenter_api.ini.php';
}
