        ...
        setStatus: function (id, is_enable)
        {
            ...
            }, function (data)
            {
                if (data && data.status == 200)
                {
                    ...
                    if (id == 'Plugin_Fenxiao' && is_enable == 1) {
                        $('#grid').jqGrid('setCell', 'Plugin_Directseller', 'plugin_state', 0);
                        //$('#grid').jqGrid('setCell', 'Plugin_Distribution', 'plugin_state', 0);
                    } else if ($.inArray(id, ['Plugin_Directseller']) > -1 && is_enable == 1) {
                        $('#grid').jqGrid('setCell', 'Plugin_Fenxiao', 'plugin_state', 0);
                    }
                }
                else
                {
