...
var handle = {
    ...
    {         
        ...
        $.dialog({
            title: i,
            content: "url:"+ SITE_URL + "?ctl=Supplier_Manage&met=shop_edit&act="+t+"&pageid="+e,
            data: a,
            width: 700,
            height: 500,
            max: !1,
    ...
    }, del: function (t)
    {
        ...
        {
            Public.ajaxPost(SITE_URL + "?ctl=Supplier_Manage&met=del&typ=json", {shop_id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
