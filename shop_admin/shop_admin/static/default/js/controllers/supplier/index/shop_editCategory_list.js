...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        $("#grid").jqGrid({
            url:SITE_URL +  "?ctl=Supplier_Manage&met=editCategory&typ=json",
...
var handle = {
    ...
    {         
        ...
        $.dialog({
            title: i,
            content: "url:"+ SITE_URL + "?ctl=Supplier_Manage&met="+t+"ShopCategory&shop_class_bind_id="+e+"&shop_id="+urlParam.shop_id,
            data: a,
            width: 700,
            height: 200,
            max: !1,
        ...
        status: function (t)
    {
        ...
        {
            Public.ajaxPost(SITE_URL + "?ctl=Supplier_Manage&met=categoryStatus&typ=json", {shop_class_bind_id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
