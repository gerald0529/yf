...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'create_time', label:'申请时间',  width:150, align:"center"},
        ...
        $("#grid").jqGrid({
            url:SITE_URL +  "?ctl=Supplier_Manage&met=reopenlist&typ=json",
...
var handle = {
    ...
    del: function (t)
    {
        ...
        {
            Public.ajaxPost(SITE_URL + "?ctl=Supplier_Manage&met=delReopen&typ=json", {id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
    ...
    status: function (t)
    {
        ...
        {
            Public.ajaxPost(SITE_URL + "?ctl=Supplier_Manage&met=examineReopen&typ=json", {id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
                    parent.Public.tips({content: "成功！"});
                    location.href= SITE_URL + "?ctl=Supplier_Manage&met=reopen"; 
                }
                else
                {
