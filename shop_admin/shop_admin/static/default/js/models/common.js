...
Public.Tips.prototype = {
    ...
    _create : function(){
        ...
        if(opts.autoClose) {
            this.obj = $('<div class="ui-tips" style="width:130px;min-height:20px;padding:5px 30px;font-size:12px;border:1px solid;border-radius:2px"><i></i></div>').append(opts.content);
        } else {
...
Business.filterBrand = function(){
    ...
    $('#filter-brand .ui-icon-ellipsis').on('click', function(){
        ...
        $.dialog({
            ...
            data:{callback:function(a,b){$("#brand_id").data('id',a),$("#brand_id").val(b)},isDelete:2},
            lock: true,
            ok: function(){
                if(typeof this.content.callback === 'function'){
                    this.content.callback();
