		...
		<div class="fixed-bar">
			<div class="item-title">
				...
				<ul class="tab-base nc-row">
					...
					<li><a class="current"><span>续签申请</span></a></li>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/supplier/index/shop_reopen_list.js" charset="utf-8"></script>
<?php
