...
<div class="wrapper page">
	<div class="fixed-bar">
		<div class="item-title">
			<div class="subject">
				<h3>供应商管理</h3>
				<h5>供应商管理-审核供应商提交的开店信息</h5>
			</div>
			<ul class="tab-base nc-row">
				<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Manage&met=indexs" ><span>供应商管理</span></a></li>
				<li><a class="current"><span>审核开店信息</span></a></li>
                <li><a  href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Manage&met=pay" ><span>审核供应商付款</span></a></li>
    ...
    <div class="mod-toolbar-top cf">
		...
		<div class="fr">
			 <a class="ui-btn" id="reaudit">审核<i class="iconfont icon-shenhe"></i></a>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/supplier/join/shop_join_list.js" charset="utf-8"></script>
  <?php
