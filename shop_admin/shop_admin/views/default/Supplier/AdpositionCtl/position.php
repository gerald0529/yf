...
$(".m .block").click(function(){
	...
	var width = $(this).css("width");
         $.dialog({
                title: "模块编辑",
                content: "url:"+ SITE_URL +"?ctl=Supplier_Adposition&met="+data_type+"&op=iframe&page_id=<?php echo $data['page_id'] ?>&layout_id=<?php echo $data['layout_id'] ?>&widget_name="+name+"&width="+width+"&height="+height,
                data:{callback: testF},
                width: 700,
                height: 550,
                max: !1,
...
$(".tit_nav").click(function(){
        $.dialog({
                title: "分类设置",
                content: "url:"+ SITE_URL +"?ctl=Supplier_Adposition&met=nav&op=iframe&page_id=<?php echo $data['page_id'] ?>",
                data:{callback: testF},
                width: 700,
                height: 550,
                max: !1,
