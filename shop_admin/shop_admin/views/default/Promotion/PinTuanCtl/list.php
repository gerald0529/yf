...
?>
            ...
            <div class="mod-search cf">
                <div class="fl">
                    <ul class="ul-inline">
                        ...
                        <li>
                            <input type="text" id="pintuan_name" name="pintuan_name" class="ui-input ui-input-ph matchCon" placeholder="活动名称">
    ...
    <script src="<?= Yf_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/pintuan/pintuan_list.js"></script>
<?php
